...
export function useRunActions({
  repoId, setRuns, setSelectedRunId, setPendingCases,
  setRecordedResults, setRecordingCase, setCaseBody, announce, setError, lastFocusRef,
}: Params) {
  ...
  return {
    confirmingDeleteRun, setConfirmingDeleteRun, deletingRun,
    renamingRunId, setRenamingRunId, renameNewSlug, setRenameNewSlug, renaming,
    handleDeleteRun, handleRenameRun,
  };
}
