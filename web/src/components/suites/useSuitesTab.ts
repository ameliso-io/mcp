...
export function useSuitesTab({
  ...
  const del = useSuiteDelete({
    repoId,
    setSuites: list.setSuites,
    setError: list.setError,
    expanded: expand.expanded,
    setExpanded: expand.setExpanded,
    announce,
    load: list.load,
  });
